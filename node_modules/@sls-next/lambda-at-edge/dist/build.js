        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (routesManifest.i18n) {
                ...
                defaultBuildManifest.pages.ssr = {
                    dynamic: Object.assign(Object.assign({}, ssrPages.dynamic), localeSsrPages.dynamic),
    ...
    buildStaticAssets(defaultBuildManifest, routesManifest) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const locale of locales) {
                ...
                fallbackHTMLPageAssets.concat(Object.values((_c = prerenderManifest.dynamicRoutes) !== null && _c !== void 0 ? _c : {})
                    .filter(({ fallback }) => {
                    return !!fallback;
                })
                    .map((routeConfig) => {

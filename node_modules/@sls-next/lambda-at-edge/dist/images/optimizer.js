...
const fileExists_1 = require("../lib/fileExists");
...
function imageOptimizer(req, res, parsedUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let maxAge;
        if (isAbsolute) {
            const upstreamRes = yield fetch(href);
            if (!upstreamRes.ok) {
            ...
            try {
                ...
                const resBuffers = [];
                const mockRes = new stream_1.default.Writable();
                mockRes.write = (chunk) => {
        ...
        else if ((upstreamType === null || upstreamType === void 0 ? void 0 : upstreamType.startsWith("image/")) && serve_static_1.getExtension(upstreamType)) {
        ...
        try {
            ...
            const extension = serve_static_1.getExtension(contentType);
